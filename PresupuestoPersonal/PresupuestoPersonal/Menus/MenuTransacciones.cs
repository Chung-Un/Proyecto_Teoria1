...
namespace PresupuestoPersonal.Menus
{
    public class MenuTransacciones
    {
        ...
        private static void Listar()
        {
            ...
            Console.Write("Tipo (ingreso/gasto/ahorro) o Enter para todos: ");
        ...
        private static void Registrar(Usuario usuario)
        {
            ...
            Console.Write("Anio imputacion:         ");
            nueva.AnioTransaccion = short.Parse(Console.ReadLine());

            Console.Write("Mes imputacion (1-12):   ");
            nueva.MesTransaccion = byte.Parse(Console.ReadLine());
        ...
        private static void Actualizar(Usuario usuario)
        {
            ...
            if (!string.IsNullOrEmpty(fecha)) t.FechaTransaccion = DateOnly.ParseExact(fecha, "dd/MM/yyyy");

            Console.Write($"Anio [{t.AnioTransaccion}]: ");
            string anio = Console.ReadLine();
            if (!string.IsNullOrEmpty(anio)) t.AnioTransaccion = short.Parse(anio);

            Console.Write($"Mes [{t.MesTransaccion}]: ");
            string mes = Console.ReadLine();
            if (!string.IsNullOrEmpty(mes)) t.MesTransaccion = byte.Parse(mes);
